...
import { DepositWalletInfo } from 'src/auth/dto/deposit-info.dto';
...
export class AuthController {
  ...
  getDepositWallet(
    @Request() request,
    @Query() depositWalletInfoDto: DepositWalletInfo,
  ) {
    return this.service.depositWalletInfo(request.user, depositWalletInfoDto);
  }
}
